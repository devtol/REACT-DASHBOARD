            ...
            <div className="userContainer">
                <div className="userShow">
                    <div className="userShowTop">
                        <img src="https://images.pexels.com/photos/47547/squirrel-animal-cute-rodents-47547.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" className="userShowImg" />
                        <div className="useShowTopTitle">
                            <span className="userShowUsername">John Snow</span>
                            <span className="userShowUserTitle">Sofeware Engineer</span>
                        </div>
                    </div>
